-----------------------------------------------------------------------
-------  15.1 Controllo Coerenza ICU
-- Titoli	Coerenza ICU	Titolo: valorizzato C_ENDTOSAPSFCD 
-----------------------------------------------------------------------
...
update #PE set d_cutoff = '2017-01-01' where d_cutoff is null 
...
select K.pos, K.nome_kpi, K.kpi, K.f_raggruppa_prodotto,
	   ...
	   C.d_effetto, C.c_tipo_titolo, C.c_esito,	C.c_motivo_storno, C.c_modalita_pagamento, C.C_ENDTOSAPSFCD
into #ESTR
from #PE    K
