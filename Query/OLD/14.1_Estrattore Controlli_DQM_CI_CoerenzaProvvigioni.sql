-----------------------------------------------------------------------
-------  14.1 Controllo coerenza  Provvigioni
-----------------------------------------------------------------------
...
select  T.pos, T.c_Tipo_GestioneProdotto, T.c_ramo_ministeriale,
		...
		provvigione_incasso_titolo = isnull(T.i_provvigione_incasso, 0),provvigione_acquisto_titolo = isnull(T.i_provvigione_acquisto, 0),
		provvigione_incasso_titolo_dettaglio = isnull (D.i_provvigione_incasso, 0),provvigione_acquisto_titolo_dettaglio = isnull(D.i_provvigione_acquisto, 0)
...
T.i_provvigione_incasso,T.i_provvigione_acquisto,D.i_provvigione_incasso,D.i_provvigione_acquisto
...
update #ESTR set esito = Case
							when provvigione_incasso_titolo<>0 and provvigione_acquisto_titolo=0 then @ESITOOK 
							when provvigione_incasso_titolo=0 and provvigione_acquisto_titolo<>0 then @ESITOOK 
							when provvigione_incasso_titolo_dettaglio= 0 and provvigione_acquisto_titolo_dettaglio<>0 then @ESITOOK 
							when provvigione_incasso_titolo_dettaglio<> 0 and provvigione_acquisto_titolo_dettaglio=0 then @ESITOOK 
							when provvigione_incasso_titolo_dettaglio= 0 and provvigione_acquisto_titolo_dettaglio=0 then @ESITOOK 
							else @ESITOKO end 
